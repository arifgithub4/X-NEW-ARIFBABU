...
module.exports.run = async function({ api, event, Users, Threads }) {
  ...
  (typeof data.customLeave == "undefined") ? msg = "✧══════•❁𝗚𝗢𝗢𝗗𝗕𝗬𝗘❁•══════✧\n\n\nसुकर है इस ग्रुप में एक ठरकी कम हो गया 😀👈\nनाम  𒁍  {name}\nरीजन  𒁍 {type} 🤐✌️\n════════════════════════ ❁\n\nबाय बाय ठरकी इंसान गुड {session}\n{time} ♥️♥️" : msg = data.customLeave;
  msg = msg.replace(/\{name}/g, name).replace(/\{type}/g, type);

  var link = [  
"https://i.imgur.com/m8mov0c.jpeg",
"https://i.imgur.com/AOb1UFF.jpeg",
"https://i.imgur.com/CNajSky.jpeg",
"https://i.imgur.com/K6u2IAV.jpeg",
"https://i.imgur.com/OjZoOMK.jpeg",
  ];
